  ...
  return (
    ...
    >
      <form method="POST" action="https://getform.io/f/901264f5-cb21-43a7-83d9-afc5d92f94be" className="flex flex-col max-w-[600px] w-full">
        ...
        <input className="bg-[#ccd6f6] p-2 hover:scale-105 duration-300" type="text" placeholder="Name" name="name" />
        <input className="my-4 p-2 bg-[#ccd6f6] hover:scale-105 duration-300" type="email" placeholder="Email" name="email" />
